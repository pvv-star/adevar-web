...
export const CHARTS = [
  ...
  { id: 'heating',     file: 'heating.json', icon: '♨️', category: 'energy',
  ...
  { id: 'emigration',  file: 'emigration.json', icon: '🛫', category: 'demography',
    ro: 'Emigranți (total)',             en: 'Emigrants (total)',            ru: 'Эмигранты (всего)',
    desc: {
      ro: 'Numărul total anual al emigranților autorizați, conform BNS StatBank.',
      en: 'Annual total number of authorized emigrants, from NBS StatBank.',
      ru: 'Годовое общее число разрешённых эмигрантов по данным НБС StatBank.',
    }
  },
  { id: 'urbanization', file: 'urbanization.json', icon: '🏙️', category: 'demography',
    ro: 'Populația Urbană',           en: 'Urban Population',          ru: 'Городское население',
    desc: {
      ro: 'Numărul populației urbane (rezidență obișnuită), conform BNS StatBank.',
      en: 'Urban resident population count, from NBS StatBank.',
      ru: 'Численность городского населения (обычное место жительства), по данным НБС StatBank.',
    }
  },
  ...
  // ── infrastructure ──
  { id: 'internet',    file: 'internet.json', icon: '🌐', category: 'infrastructure',
    ro: 'Utilizatori Internet în bandă largă',     en: 'Broadband Internet Users',       ru: 'Пользователи широкополосного Интернета',
    desc: {
      ro: 'Numărul utilizatorilor cu acces la Internet în bandă largă, conform BNS StatBank.',
      en: 'Number of broadband internet users, from NBS StatBank.',
      ru: 'Количество пользователей широкополосного Интернета по данным НБС StatBank.',
    }
  },
  { id: 'roads',       file: 'roads.json', icon: '🛣️', category: 'infrastructure',
...
const DATA_LOADERS = {
  ...
  emigration: () => import('@/data/charts/emigration.json'),
  urbanization: () => import('@/data/charts/urbanization.json'),
  internet: () => import('@/data/charts/internet.json'),
  roads: () => import('@/data/charts/roads.json'),
