...
export const CATEGORIES = {
  ...
  infrastructure: { ro: 'Infrastructură', en: 'Infrastructure',  ru: 'Infrastructură' },
...
export const CHARTS = [
  ...
  { id: 'electricity', file: 'electricity.json',  icon: '', category: 'energy',
    ...
    desc: {
      ro: 'Tarifele la energie electrică pentru consumatorii casnici şi industriali.',
  ...
  { id: 'heating',     file: null, icon: '', category: 'energy', soon: true,
    ...
    desc: {
      ro: 'Tariful pentru încălzire centralizată şi apă caldă, pe furnizori şi perioade.',
  ...
  { id: 'inflation',   file: 'inflation.json', icon: '', category: 'economy',
    ...
    desc: {
      ro: 'Indicele prețurilor de consum (IPC) lunar şi anual, conform BNS.',
  ...
  { id: 'salary',      file: null, icon: '', category: 'economy', soon: true,
    ro: 'Salariul Mediu',        en: 'Average Salary',        ru: 'Средняя зарплата',
    desc: {
      ro: 'Salariul mediu brut pe economie, pe sectoare şi regiuni, conform BNS.',
  ...
  { id: 'gdp',         file: null, icon: '', category: 'economy', soon: true,
    ...
    desc: {
      ro: 'Produsul Intern Brut per locuitor în MDL şi USD, evoluție anuală.',
  ...
  { id: 'exchange',    file: null, icon: '', category: 'economy', soon: true,
    ...
    desc: {
      ro: 'Cursul oficial MDL față de EUR şi USD, date zilnice de la BNM.',
  ...
  { id: 'remittances', file: null, icon: '', category: 'economy', soon: true,
  ...
  { id: 'population',  file: null, icon: '', category: 'demography', soon: true,
    ...
    desc: {
      ro: 'Numărul populației stabile şi rezidente pe ani, conform recensământelor şi estimărilor BNS.',
  ...
  { id: 'emigration',  file: null, icon: '', category: 'demography', soon: true,
    ...
    desc: {
      ro: 'Numărul cetățenilor emigrați definitiv şi temporar, destinații principale.',
  ...
  { id: 'urbanization', file: null, icon: '', category: 'demography', soon: true,
    ...
    desc: {
      ro: 'Ponderea populației urbane față de cea rurală, evoluție istorică şi prognoze.',
  ...
  { id: 'internet',    file: null, icon: '', category: 'infrastructure', soon: true,
    ...
    desc: {
      ro: 'Rata de penetrare a internetului în gospodării şi pe tipuri de conexiune.',
  ...
  { id: 'roads',       file: null, icon: '', category: 'infrastructure', soon: true,
    ...
    desc: {
      ro: 'Starea drumurilor publice naționale şi locale pe categorii de calitate.',
