...
import gdpData from '@/data/charts/gdp.json';
import exchangeData from '@/data/charts/exchange.json';
import remittancesData from '@/data/charts/remittances.json';
import unemploymentData from '@/data/charts/unemployment.json';
import birthsSexData from '@/data/charts/births-sex.json';
import populationData from '@/data/charts/population.json';
